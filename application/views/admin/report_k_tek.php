        ...
        <div class="col-xs-12">
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Kompetensi (Teknologi Informasi)</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                
                  <div class="box-body">
                  <div class="form-group">
                      <form method="post" action="<?php echo base_url() ?>admin_report/reportKompetensiTeknologiInformasi">
                  ...
                  <input type="hidden" name="a" value="f1767">
                  <input type="hidden" name="b" value="f1768">
                  </div>
                    <div class="form-group">
