 ...
 <!-- left column -->
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form method="post" action="<?php echo base_url() ?>admin/beritaip" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>Judul Berita</label>
                  <input type="text" class="form-control autocomplete" id="nama" name="nama" placeholder="Judul Berita">
