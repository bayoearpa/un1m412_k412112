<section id="blog" class="container">
        <div class="center">
            ...
            <p class="lead">Halaman kegiatan yang telah dilakukan tim Pusat Karir UNIMAR AMNI Semarang</p>
        </div>
                    ...
                    <div class="blog-item">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-10 blog-content">
                                <a href="#"><?php 
                    if(empty($row->file)) {echo "<img src='".base_url()."assets/upload/berita/no_image_thumb.png' width='300'>";}  
                    else { echo " <img src='".base_url()."assets/upload/berita/".$row->file.''.$row->file_type."' width='300'> ";}
            ?></a>
                                <h2><a href="blog-item.html"><?php echo $row->nama; ?></a></h2>
                                <!-- <h3>Curabitur quis libero leo, pharetra mattis eros. Praesent consequat libero eget dolor convallis vel rhoncus magna scelerisque. Donec nisl ante, elementum eget posuere a, consectetur a metus. Proin a adipiscing sapien. Suspendisse vehicula porta lectus vel semper. Nullam sapien elit, lacinia eu tristique non.posuere at mi. Morbi at turpis id urna ullamcorper ullamcorper.</h3> -->
                                <a class="btn btn-primary readmore" href="<?php echo base_url() ?>welcome/detailberita/<?php echo $row->id_berita; ?>">Read More <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>    
                    </div><!--/.blog-item-->
                     <?php } ?>
