...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/3/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <img src="<?php echo base_url() ?>assets/3/dist/img/amni1.png" width="20%">
    <a href="../../index3.html"><b>Admin</b> Pusat Karir</a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="<?php echo base_url() ?>assets/3/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
