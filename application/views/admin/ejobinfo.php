 ...
 <!-- left column -->
          ...
          <div class="box box-primary">
            ...
            foreach ($job as $j) {
              # code...
             ?>
          <form method="post" action="<?php echo base_url() ?>admin/jobinfoep" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label>Nama Perusahaan</label>
                  <input type="hidden" name="id_job" id="id_job" value="<?php echo $j->id_job ?>" >
                  <input type="text" class="form-control autocomplete" id="nama" name="nama" value="<?php echo $j->nama ?>" placeholder="Nama Perusahaan">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="keterangan" name="keterangan"><?php echo $j->keterangan ?></textarea>
                ...
                <div class="form-group">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <option value="2">Hak Cipta</option>                       
                     ...
                     <div class="form-group">
                  <label>Gambar</label>
                  <input type="file" class="form-control" name="file" id="file" value="<?php echo $j->file ?>" onchange="tampilkanPreview(this,'preview')"/>
