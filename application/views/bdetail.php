<section id="blog" class="container">
        <div class="center">
            ...
            <p class="lead">Halaman kegiatan yang telah dilakukan tim Pusat Karir STIMART "AMNI" Semarang</p>
        </div>
        ...
        <div class="blog">
            ...
            ?></a>
                                ...
                                <!-- <a class="btn btn-primary readmore" href="<?php echo base_url() ?>detailberita">Read More <i class="fa fa-angle-right"></i></a> -->
                            </div>
                        </div>    
                    </div><!--/.blog-item-->
                     <?php } ?>
